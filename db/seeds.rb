...
# UserDetail.create( user_id: 3, family_name:'山田', first_name:'彩', family_name_kana:'ヤマダ', first_name_kana:'アヤ', birthday: '2009-01-01', point_id:'1', address:'青山', zip_code:'123-4567', phone_number:'09012345678', birthyear: '2009-01-01', birthmonth: '2009-01-01', prefecture:'東京都', city:'千代田区', building:'ビル' )
